...
- `migrations/` 累计 26 个 migration(2026-05-02 `init` → 2026-06-24 招新四期 S4b:recruitment_applications +4 OCR 六分流列〔manualReviewReason/riskLevel/applicantConfirmedOcrWrong/lastOcrOutcome;全 additive,无 enum、无不可逆〕)。
