...
export const RBAC_SEED_CATALOG = Object.freeze({
  ...
  permissions: Object.freeze({
    ...
    activityContributionPolicy: readonlyPermissionSeeds(
      ACTIVITY_CONTRIBUTION_POLICY_PERMISSION_SEED,
    ),
    ...
    delegationGrantControlPlane: readonlyPermissionSeeds(DELEGATION_GRANT_PERMISSION_SEED),
  }),
  roles: Object.freeze({
  ...
  contract: Object.freeze({
    ...
    reservedSuperAdminOnlyPermissionCodes: RESERVED_SUPER_ADMIN_ONLY_PERMISSION_CODES,
