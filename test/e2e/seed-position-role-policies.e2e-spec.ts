...
//      ops-admin 94(F3「C 组」起)/ member 9 / biz-admin 73(F4「D 组」起)绑定数不变;
...
// 既有 3 角色绑定数零漂移基线(seed-rbac 94 / seed-attachment 9 / seed-biz-admin 73 同口径;
...
describe('prisma/seed.ts — PR7 position role policies + PR9 final reviewer(内置角色 7)', () => {
  ...
  it('5. 零指派 + 零漂移:3 新角色无任何持有者;ops-admin 94(F3「C 组」起)/ member 9 / biz-admin 73(F4「D 组」起)不变;保留码不绑', async () => {
