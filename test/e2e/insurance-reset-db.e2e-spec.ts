  ...
  async function createFixture(label: string): Promise<{
    ...
    const activity = await prisma.activity.create({
      data: {
        ...
        startAt: new Date('2099-01-10T00:00:00.000Z'),
        endAt: new Date('2099-01-10T08:00:00.000Z'),
    ...
    const memberInsurance = await prisma.memberInsurance.create({
      data: {
        ...
        reviewedAt: new Date('2099-01-02T00:00:00.000Z'),
      },
      select: { id: true },
    });
    ...
    const selfEvidence = await prisma.insuranceEligibilityEvidence.create({
      data: {
        ...
        sourceReviewedAt: new Date('2099-01-02T00:00:00.000Z'),
        requiredFrom: new Date('2099-01-10T00:00:00.000Z'),
        requiredThrough: new Date('2099-01-10T00:00:00.000Z'),
