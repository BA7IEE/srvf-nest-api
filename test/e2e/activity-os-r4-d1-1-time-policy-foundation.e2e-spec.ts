...
describe('D1-1 time policy physical foundation', () => {
  beforeAll(() => {
    ...
    raw(
      `BEGIN; ${timeLedgerFixtureTriggerSql().before} TRUNCATE "CorrectionTimeAllocationBinding", "CorrectionPendingTimeAllocationEvidence", "CorrectionTimeSourceProof", "CorrectionPendingTimeAllocation", "ParticipationTimeCorrectionCommitReceipt", "ParticipationTimeCorrectionEntry", "ParticipationTimeCorrectionManifest", "ParticipationTimeLedgerEntry", "ParticipationTimeLedgerManifest", "ActivitySettlementTimeCommandReceipt", "ParticipantSettlementTimeBucketSource", "ParticipantSettlementTimeBucket", "ActivitySettlementTimeRevision", "ParticipantTimeAllocationCommandReceipt", "ParticipantTimeAllocationEvidence", "ParticipantTimeAllocationSlice", "ParticipantTimeAllocationRevision", "ActivityTimePolicySelectionItem", "TimePolicyCommandReceipt", "TimePolicyVersion", "TimePolicy"; ${timeLedgerFixtureTriggerSql().after} DELETE FROM "User" WHERE id='tp-test-user'; COMMIT;`,
    );
  });
