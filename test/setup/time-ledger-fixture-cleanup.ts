  ...
  return {
    ...
    after: `DO $d6_fixture$
      ...
      BEGIN
        ...
        LOOP
          IF NOT ((item->>'table'='ActivityContributionPolicySelectionCommandReceipt' AND item->>'trigger'='acps_receipt_no_truncate') OR
