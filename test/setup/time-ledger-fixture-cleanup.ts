  ...
  return {
    ...
    after: `DO $d6_fixture$
      ...
      BEGIN
        ...
        LOOP
          IF NOT ((item->>'table'='CorrectionPendingTimeAllocation' AND item->>'trigger'='cpta_no_truncate') OR
