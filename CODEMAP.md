...
| `attendances/` | ⚠G (service 1157L) | 考勤主表 5 态(含终审)+ contribution 计算 | P1-C step 4 已完成(PR #236):`AttendanceRecordsMeController` 迁至 `controllers/attendances-me-records-legacy.controller.ts`,主 `attendances.controller.ts` 仅剩 2 个 Admin controller;god-service 不主动拆 | [`CLAUDE.md`](src/modules/attendances/CLAUDE.md) · [`docs/participation-bounded-context.md`](docs/participation-bounded-context.md) |
