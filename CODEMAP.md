...
| `migrations/` | 25 个 migration(2026-05-02 init → 2026-06-24 招新四期 S4a:SmsPurpose +RECRUITMENT_BIND〔不可逆〕+ recruitment_identity_session〔新表 + application +6 手机身份链列〕) | **禁止** `prisma migrate dev` / `reset` / `db push` 自动跑 | [`CLAUDE.md`](prisma/CLAUDE.md) · [`AGENTS.md §0`](AGENTS.md) |
