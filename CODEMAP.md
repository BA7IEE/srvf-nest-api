...
| `migrations/` | 14 个 migration(2026-05-02 init → 2026-06-11 sms purpose password reset) | **禁止** `prisma migrate dev` / `reset` / `db push` 自动跑 | [`CLAUDE.md`](prisma/CLAUDE.md) · [`AGENTS.md §0`](AGENTS.md) |
