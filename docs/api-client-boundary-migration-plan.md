...
>   - [`docs/app-api-phase-2-review.md`](app-api-phase-2-review.md) — **Phase 2 实施前评审稿**(15 个候选 endpoint + 8 PR 串 + DTO 命名 + capabilities 设计 + identity/access 矩阵 + 风险表;Phase 2 实施必须先消化本节并按 P2-0 ~ P2-7 串行落地)
>
