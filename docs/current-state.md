...
| P1 | docs/ 体系庞大(根 6 大文档 + docs/ 50+ 文件) | ✅ 2026-05-21 治理收口 PR 已将 49 份历史 handoff / 评审稿 / 批次 / first-release 过程档案 / FINAL_REPORT 迁至 [`archive/`](archive/);剩余 `srvf-foundation-data-model-draft.md` 等 V2 设计期产物维持现状,需要时再归档 |
