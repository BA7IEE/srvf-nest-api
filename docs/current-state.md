...
- **开启 `ACTIVITY_V11_WORKFLOW_ENABLED`**(活动 v1.1 单一 cutover gate,合同 §16.2;闸位代码
  ...
  **开闸前的仓内硬前置只剩 9a**(验收 todo 已 9→6:AC-047 补执行位结案(#1213)、
  AC-009/AC-067 永久豁免、AC-017 搁置(均 2026-08-28 拍板);AC-010 改期刀在做;
  余 AC-013/AC-020/AC-025 三条大刀维持「上线后按诉求立项」+ ADV-010 卡 P2-21)与
