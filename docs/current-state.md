...
- **测试与契约**:e2e **86 suites / 1787 tests** + unit **34 spec / 1301 tests**(2026-06-12 true-up:+date-only 5 例〔#343〕+auth.service characterization 27 例〔#344〕+crash-handlers 5 例〔#345〕)+ contract **159 路由**白名单;CI 全链 + docker-smoke(含生日 cron 启动锚行)
