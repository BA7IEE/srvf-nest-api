...
- **活动业务改造**:第 0–3 批已收口;第 4 批 Form/附件会话/canonical 报名命令与发布审核容量桶投影已接通，旧创建入口对 v1.1 fail-closed；合同 [`activity-business-overhaul-v1.1`](archive/reviews/activity-business-overhaul-v1.1/README.md)，执行位 `NEXT_TASKS` P1-28。
