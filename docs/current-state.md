...
- **活动业务改造**（activity-business-overhaul-v1.1）：82、永久头同头重报、保险 revision 取证及个人取消/拒绝/重开参与投影闭环已落，AC-021/ADV-005 有十轮实证；整单 cancel/旧 waitlist writer 仍为旁路债务，资格/分配待（NEXT_TASKS P1-28）。
