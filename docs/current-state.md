...
- **Route B 全量迁移已立项冻结**(2026-06-01;取代原"Phase 1B 暂缓 / 方案 C")— 见 [`api-surface-migration-plan.md`](api-surface-migration-plan.md) + [`AGENTS.md §21 D-9`](../AGENTS.md);迁移分 Phase 0 ~ 4,**每阶段 D 档、单独立项、串行、AI 不自动启动**;`/api/open/v1/*` 仅预留不实现
