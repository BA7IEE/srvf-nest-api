...
- **活动业务改造**:第 0–3 批已收口;第 4 批 Form runtime / 一次性附件会话已接通。合同见 [`activity-business-overhaul-v1.1`](archive/reviews/activity-business-overhaul-v1.1/README.md)，执行位见 `NEXT_TASKS` P1-28。
