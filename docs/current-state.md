...
| 项 | 当前值 |
|---|---|
| **发布边界** | 🟢 **代码 Release GO(2026-08-02,v0.65.0 已发)** —— 外部评审对 `56ea8480..b6a2f9d8` 终局判 GO(0 P0/P1);**生产部署仍是独立硬门**,migration 67/68/**69** 生产执行、首批标准初始化、前端适配、企微联调按各 runbook 单独审批;活动责任、保险、Storage、外部通道、基础设施硬门仍开放(§4 / runbook) |
