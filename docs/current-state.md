...
| `main` HEAD | **`0e2b819`** `docs(governance): refine worktree cleanup SOP wording (#226)`(post-v0.15.0 docs 治理 + 架构边界抽离串 + Governance-1A Phase G1-PR-A ~ G1-PR-I 串累计落地 + **G2-PR-A / G-11 worktree cleanup SOP 已落地** + **G2-PR-A 后续微调(PR #226)已落地**;本次为复合 refresh,覆盖 PR #225 + PR #226 两拍 drift;v0.15.0 release tag 仍指向 `089499d` = PR #163 handoff squash commit,2026-05-24 核对) |
