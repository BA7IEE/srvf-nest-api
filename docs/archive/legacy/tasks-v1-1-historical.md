...
>
> 本文件是 `TASKS.md` 原 §0-§4 的历史快照,包含 **V1.1 工程加固任务卡**(任务 15.1-15.9)+ 配套范围速读 / 任务总览 / checklist / 范围外处理。
>
> **当前状态**:
> - V1.1 工程加固已于 v0.1.5 / v0.1.6 收口
> - 本文件**只作历史证据**,不再作为当前执行约束
>
> **承接当前事实**:
> - 已落地工程能力 → [`docs/current-state.md §2`](../../current-state.md) "V1.1 工程加固"段
> - 架构蓝图 → [`ARCHITECTURE.md §11`](../../../ARCHITECTURE.md) "V1.1 Engineering Hardening"
> - 长期 AI 协作铁律 → [`AGENTS.md`](../../../AGENTS.md)(原 §17 V1.1 规则已自承归档)
>
> **PR-1 归档边界**:`TASKS.md` 原 §0-§4(lines 1-503,从 commit `bbc47bf` 起)完整迁出,**未做内容编辑**;原文件 `# TASKS.md — V1.1 工程加固任务清单` 标题作为历史标识保留。
>
