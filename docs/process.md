...
| **历史立项 / 评估** | [`docs/v1.3-plan.md`](v1.3-plan.md) / [`docs/v1.4-prisma7-evaluation.md`](v1.4-prisma7-evaluation.md) / [`docs/srvf-foundation-data-model-draft.md`](srvf-foundation-data-model-draft.md) | ❌ 归档,不回改 | 历史决策依据 |
