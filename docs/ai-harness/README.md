...
| [`LEGACY_LEDGER_CONVERSION_DRAFT.md`](LEGACY_LEDGER_CONVERSION_DRAFT.md) | 「存量考勤账本化」转换刀评审稿**草案(未冻结)** —— 第 7 批②账本桥 A 案(2026-08-27 拍板「按推荐」):锚点证据、设计决策 D1–D13、DoD、§16.3 SOP 集成;维护者评审通过后另立冻结件入 `archive/reviews/` |
