...
| 一级域 | 条数 | 权限码 |
|---|---|---|
| `activity` | 26 | `activity.cancel.record` · `activity.complete.record` · `activity.contribution-policy.read` · `activity.contribution-policy.select` · `activity.create.cross-org` · `activity.create.emergency.record` · `activity.create.record` · `activity.delete.record` · `activity.outcome.calculate` · `activity.outcome.confirm` · `activity.outcome.correct` · `activity.outcome.read` · `activity.outcome.record` · `activity.publish.record` · `activity.settlement-close.record` · `activity.settlement-final-review.record` · `activity.settlement-first-review.record` · `activity.settlement-generate.record` · `activity.settlement-submit.record` · `activity.settlement-update-draft.record` · `activity.time-allocation.recognize` · `activity.time-policy.read` · `activity.time-policy.select` · `activity.time-settlement.prepare` · `activity.time-settlement.read` · `activity.update.record` |
...
| `activity-metric` | 4 | `activity-metric.manage.definition` · `activity-metric.manage.rule-binding` · `activity-metric.manage.set` · `activity-metric.read.catalog` |
...
### 角色 → 权限码覆盖(15 个内建角色;238/269 条码有持有人)
...
| `admin/v1/activities` | `src/modules/activities/controllers/admin-activity-contribution-policy-selection.controller.ts` |
...
| `admin/v1/activities` | `src/modules/activities/controllers/admin-activity-time-policy-selection.controller.ts` |
...
| `admin/v1/activity-metric-rule-bindings` | `src/modules/activities/controllers/admin-activity-metric-rule-bindings.controller.ts` |
...
| `admin/v1/activity-time-policies` | `src/modules/activities/controllers/admin-activity-time-policies.controller.ts` |
...
| `app/v1/my/managed-activities` | `src/modules/activities/controllers/app-managed-activity-contribution-policy-selection.controller.ts` |
| `app/v1/my/managed-activities` | `src/modules/activities/controllers/app-managed-activity-creation.controller.ts` |
| `app/v1/my/managed-activities` | `src/modules/activities/controllers/app-managed-activity-metric-candidates.controller.ts` |
| `app/v1/my/managed-activities` | `src/modules/activities/controllers/app-managed-activity-metrics.controller.ts` |
| `app/v1/my/managed-activities` | `src/modules/activities/controllers/app-managed-activity-outcome-finalizations.controller.ts` |
| `app/v1/my/managed-activities` | `src/modules/activities/controllers/app-managed-activity-outcomes.controller.ts` |
| `app/v1/my/managed-activities` | `src/modules/activities/controllers/app-managed-activity-time-policy-selection.controller.ts` |
