...
> **D1-3 精确计划方案 A 已确认（2026-09-11）**：[计划与分段授权](../plans/activity-os-r4-d1-3-implementation-plan.md)已列140个未来路径，包含四层选择、分批PATCH完整修订、V4/V8兼容及旧测试精确适配。已允许八份文档补充changelog、提交、推送及创建计划PR；不合并、不实施。目录D1-2完成不代表D1整体完成；此条覆盖下方历史起草授权状态。
