...
### P1-33 Activity OS 终态边界、数据所有权、Integration 安全与 AI 独立性 —— **T0-A / T0-B 与 Release 1 A1、A2、A3、A4、A5 已通过；A6 待独立立项**

**状态**:进行中(T0-B #1236、A1 #1237、A2 #1239、A3 #1241、A4 #1244 与 A5 #1246 已合；A5 的显式 Template Version 精确优先 / legacy fallback 只读投影、单元 / PostgreSQL E2E、OpenAPI 零漂移、PR CI 与红区审批均已收口；A6 起仍按单轴独立立项)
...
- **串行约束**:A1、A2、A3、A4、A5 已完成独立评审、实现与 PR 验收；A6 及以后仍须按一条业务轴、additive、gate-off、shadow 对账和独立 handoff 收口，且不得沿用 A5 的授权。
