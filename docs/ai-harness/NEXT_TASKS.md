...
### P1-33 Activity OS 终态边界、数据所有权、Integration 安全与 AI 独立性 —— **T0-A / T0-B 与 Release 1 A1、A2、A3、A4、A5、A6、A7 已通过；A8 待独立立项**

**状态**:进行中(T0-B #1236、A1 #1237、A2 #1239、A3 #1241、A4 #1244、A5 #1246、A6 #1248 与 A7 #1251 已合；A7 的 immutable Series / Revision、手工／按需幂等生成、A6 同事务物化、单元 / PostgreSQL E2E、PR CI 与红区审批均已收口；A8 起仍按单轴独立立项)
