...
| 2 | RBAC 权限目录终态 | P1-32 | `↔进行中 5/9` **完整落地 5 / 9 PR**(PR 4 两半齐全) | 剩 PR 5–8;其中 PR 7 等前端(srvf-admin-web)投用 |
...
PR 4(permissionRevision + 原子 PUT,4a #1156 + 4b 读/预览面 2026-08-24,**两半齐全**)。
...
| 活动 v1.1 验收编号:已绑真实证据 / 合同定义 | **65 / 95(30 条仍 it.todo)** | `合同正式版 + activity-business-overhaul-acceptance.spec.ts` |
