...
| 9 | Activity OS T0-A 终态合同 | P1-33 | `↔进行中` T0-A / T0-B / Release 1 A1 已通过并合入 #1237；A2 schema/migration 与非空库 rehearsal 已完成 | A2 独立 PR、CI 与验收 |
...
legacy registry，不改变现有 Activity 运行时或 API。A2 方案 A 已由维护者拍板并取得精确红区
授权，Family / Version 的纯 expand、独立 schema e2e 与非空库 rehearsal 已完成；仍须独立 PR、
CI 与验收收口，不得把 A1 的 seed 授权带入后续切片。
...
| `docs/archive/reviews/activity-os-r1-a2-template-family-version-review.md` | open · P1-33 | Release 1 / A2 D 档 Family / Version expand；方案 A 已拍板，实施与 PR 验收中 |
