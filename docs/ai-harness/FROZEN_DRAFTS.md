...
> **D7-2 仓内交付已收口／D8 仅计划（2026-09-21）**：[#1339](https://github.com/BA7IEE/srvf-nest-api/pull/1339) 已 squash 合入 `main` 的 `bc428bd6b4d09d8ff0a347af7abe589cf1611997`；最终 PR HEAD `cbb49c4d` 的检查与可信审批通过，合并后 [main CI 35598127219](https://github.com/BA7IEE/srvf-nest-api/actions/runs/35598127219) 在精确合并 SHA 上 completed/success，五个 Contract + E2E 分片全部通过。#1337／#1338／#1339 均已进入 main；下方 Draft、待 CI、未合并表述为历史时点。本轮仅起草 [D8 证明读面与正式切换评审及精确计划](../plans/activity-os-r4-d8-proof-cutover-review-and-plan.md)，拆为 D8-1 地基、D8-2 官方消费者和 D8-OPS 独立生产动作；不实施、不操作数据库、不启用 Gate、不合并、不删除或重分类业务数据。整体跨模型复审、真实业务验收、前端与生产仍未完成，T0 保持 open。
...
| 9   | Activity OS T0-A 终态合同    | P1-33 | `↔进行中` T0-A/T0-B、Release 1 A1–A8、Release 2 B1–B7、Release 3 C1–C5 及 Release 4 D1–D7 已完成相应仓内实施；D7-2 #1337/#1338/#1339 已合并，#1339 main CI 35598127219 成功；D8 评审与精确计划起草中 | D8-1、D8-2、整体跨模型复审、真实业务验收、前端发布、生产部署、v1.1 Gate 与 D8-OPS 正式切换未完成；不据历史间歇性500/P2028单独宣称根因已统一定位 |
...
**⑤ Activity OS T0-A —— T0-A/T0-B、Release 1 A1–A8、Release 2 B1–B7、Release 3 C1–C5 与 Release 4 D1–D7 仓内实施已合入；D7-2 #1337/#1338/#1339 已收口，#1339 合并后 main `bc428bd6` 的 CI 35598127219 成功；D8 当前仅完成评审与精确计划起草，D8-1／D8-2、真实业务验收、整体跨模型复审、前端、部署、v1.1 Gate 与 D8-OPS 正式切换均未完成**
