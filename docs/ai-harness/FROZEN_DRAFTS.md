...
| `docs/archive/reviews/activity-service-segment-correction-conflict-review.md` | open · P1-33 | 方案文档 #1295、实现 #1296 已合入 main `638fc784`；暂存、事务内物化、准备／清理收据及受控 CLI 已交付，115 条 migration 的 3b 已重签，全部 PR CI 与可信审批通过。保留 open：整体复审、生产与真实清理未执行；后续 C3-1 仅计划，不启用 Gate |
