...
**取数时点:2026-09-05(Activity OS R3 / C1 D1 指标定义与指标集数据地基)**

| 项 | 值 |
|---|---:|
| 总条目 | **65** |
| `governed` / `inventory` | **8 / 57** |
| 57 条 inventory 的分层 | L1 **7** · L2 **24** · L3 **26** |
| 已有机器可读边(`transitions` 是数组)※ | 26 |
| `transitions: "not-derived"` ※ | 26 |
| `transitions: "unconstrained"` ※ | 13 |

> ※ 这三行按**全部 65 条**统计(26+26+13=65),不是按上一行那 57 条 inventory。
