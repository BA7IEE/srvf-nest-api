...
| inputDigest | sha256:fe518674f61cc3f08645417091d81c18945995fe254f8f2fac962e2a1279b6bf |
| endpoint count | 537 |
...
| DELETE | /api/admin/v1/members/:id | Admin - Members | rbac | RBAC; admission=-; codes=member.delete.record; require=all; scopes=-; engine=rbac-global | code | src/modules/members/members.controller.ts:244; src/modules/members/members.controller.ts:263 |
...
| GET | /api/admin/v1/members/:id | Admin - Members | rbac | RBAC; admission=-; codes=member.read.record; require=all; scopes=-; engine=rbac-global | code | src/modules/members/members.controller.ts:182; src/modules/members/members.controller.ts:196 |
| GET | /api/admin/v1/members/:id/audience-tags | Admin - Members | rbac | RBAC; admission=-; codes=member.read.record; require=all; scopes=-; engine=rbac-global | code | src/modules/members/members.controller.ts:144; src/modules/members/members.controller.ts:159 |
| GET | /api/admin/v1/members/:id/offboard-impact | Admin - Members | rbac | RBAC; admission=-; codes=member.offboard.record; require=all; scopes=-; engine=rbac-global | code | src/modules/members/members.controller.ts:399; src/modules/members/members.controller.ts:416 |
...
| GET | /api/admin/v1/members/options | Admin - Members | rbac | RBAC; admission=-; codes=member.read.record; require=all; scopes=-; engine=rbac-global | code | src/modules/members/members.controller.ts:87; src/modules/members/members.controller.ts:100 |
...
| PATCH | /api/admin/v1/members/:id | Admin - Members | rbac | RBAC; admission=-; codes=member.update.record; require=all; scopes=-; engine=rbac-global | code | src/modules/members/members.controller.ts:199; src/modules/members/members.controller.ts:218 |
| PATCH | /api/admin/v1/members/:id/account/status | Admin - Members | rbac | RBAC; admission=-; codes=user.update.status; require=all; scopes=-; engine=rbac-global | code | src/modules/members/members.controller.ts:374; src/modules/members/members.controller.ts:396 |
| PATCH | /api/admin/v1/members/:id/status | Admin - Members | rbac | RBAC; admission=-; codes=member.update.status; require=all; scopes=-; engine=rbac-global | code | src/modules/members/members.controller.ts:221; src/modules/members/members.controller.ts:241 |
...
| POST | /api/admin/v1/members | Admin - Members | rbac | RBAC; admission=-; codes=member.create.record; require=all; scopes=-; engine=rbac-global | code | src/modules/members/members.controller.ts:123; src/modules/members/members.controller.ts:141 |
| POST | /api/admin/v1/members/:id/account | Admin - Members | rbac | RBAC; admission=-; codes=member.grant.account; require=all; scopes=-; engine=rbac-global | code | src/modules/members/members.controller.ts:268; src/modules/members/members.controller.ts:291 |
| POST | /api/admin/v1/members/:id/account/bind | Admin - Members | rbac | RBAC; admission=-; codes=member.bind.account; require=all; scopes=-; engine=rbac-global | code | src/modules/members/members.controller.ts:297; src/modules/members/members.controller.ts:322 |
| POST | /api/admin/v1/members/:id/account/reopen | Admin - Members | rbac | RBAC; admission=-; codes=member.grant.account; require=all; scopes=-; engine=rbac-global | code | src/modules/members/members.controller.ts:346; src/modules/members/members.controller.ts:371 |
| POST | /api/admin/v1/members/:id/account/unbind | Admin - Members | rbac | RBAC; admission=-; codes=member.bind.account; require=all; scopes=-; engine=rbac-global | code | src/modules/members/members.controller.ts:325; src/modules/members/members.controller.ts:343 |
| POST | /api/admin/v1/members/:id/offboard | Admin - Members | rbac | RBAC; admission=-; codes=member.offboard.record; require=all; scopes=-; engine=rbac-global | code | src/modules/members/members.controller.ts:422; src/modules/members/members.controller.ts:445 |
...
| POST | /api/admin/v1/members/accounts/bulk-grant | Admin - Members | rbac | RBAC; admission=-; codes=member.grant.account; require=all; scopes=-; engine=rbac-global | code | src/modules/members/members.controller.ts:106; src/modules/members/members.controller.ts:120 |
...
| PUT | /api/admin/v1/members/:id/audience-tags | Admin - Members | rbac | RBAC; admission=-; codes=member.update.record; require=all; scopes=-; engine=rbac-global | code | src/modules/members/members.controller.ts:162; src/modules/members/members.controller.ts:179 |
