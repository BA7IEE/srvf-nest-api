...
D8-1 [#1341](https://github.com/BA7IEE/srvf-nest-api/pull/1341) 与 D8-2
[#1342](https://github.com/BA7IEE/srvf-nest-api/pull/1342) 已进入 main，仓库侧已建立切换事实、统一真相选择器、
正式证明及官方统计／新关账接线；两者仍未部署。在 D8-1／D8-2 随同一 exact main SHA 部署且本说明第4节
全部现场前置满足前，仍禁止写入切换收据。
...
D8-1／D8-2 已完成仓库合并，但没有执行生产 migration、切换、部署、Gate 修改、历史回填、重分类或
业务数据删除。D8-OPS 真实窗口仍待后续独立授权与交付。
