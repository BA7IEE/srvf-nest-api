...
describe('BizCode', () => {
  ...
  it('E1-3 贡献政策选择错误码固定为连续八项合同', () => {
    expect([
      BizCode.ACTIVITY_CONTRIBUTION_POLICY_SELECTION_INVALID.code,
      BizCode.ACTIVITY_CONTRIBUTION_POLICY_SELECTION_REFERENCE_UNAVAILABLE.code,
      BizCode.ACTIVITY_CONTRIBUTION_POLICY_SELECTION_STALE.code,
      BizCode.ACTIVITY_CONTRIBUTION_POLICY_SELECTION_COMMAND_CONFLICT.code,
      BizCode.ACTIVITY_CONTRIBUTION_POLICY_SELECTION_RECEIPT_INVALID.code,
      BizCode.ACTIVITY_CONTRIBUTION_POLICY_SELECTION_POLICY_UNAVAILABLE.code,
      BizCode.ACTIVITY_CONTRIBUTION_POLICY_SELECTION_UNCHANGED.code,
      BizCode.ACTIVITY_CONTRIBUTION_POLICY_SELECTION_REVISION_LIMIT.code,
    ]).toEqual([20247, 20248, 20249, 20250, 20251, 20252, 20253, 20254]);
  });
