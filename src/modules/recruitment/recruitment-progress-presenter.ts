...
// ===== 门槛展示名(5 项固定 code;来源 recruitment-applications.admin.controller「巡山×2/培训/急救资质/BSAFE」)=====
// 导出供 S2 工作台 stats 的「各门槛完成分布」复用同一份展示名(零第二份副本;不改 deriveRecruitmentStage 口径)。
// 注:内部门槛 code 仍为 redCross(保留不改,避免历史数据/接口兼容问题),仅显示名为「急救资质」——
// 该门槛不只认红十字会证书,深圳市急救中心等被认可机构的救护员证同样有效(2026-07-14)。
