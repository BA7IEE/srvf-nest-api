...
// 业务侧引用一个资源的最小形状:type ∈ ResourceResolver 支持的 14 类(见 resource-resolver.service.ts),
...
export interface ResolvedResource {
  ...
  // { submitterUserId, lastSubmittedByUserId, reviewerUserId }，或结算版本的
  // { submitterUserId, reviewerUserId }。
