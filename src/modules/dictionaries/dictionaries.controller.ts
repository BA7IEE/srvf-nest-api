...
// 单文件双 @Controller 类,严格遵守 baseline §5.1
// / docs/reference/naming-dto-validation.md §2 模块结构铁律。
...
export class DictTypesController {
  ...
  @Get()
  @RequiresPermission('dict.read.type')
  ...
  @Post()
  @RequiresPermission('dict.create.type')
  ...
  @Patch(':id')
  @RequiresPermission('dict.update.type')
  ...
  @Delete(':id')
  @RequiresPermission('dict.delete.type')
  @ApiOperation({
    summary:
...
export class DictItemsController {
  ...
  @Post()
  @RequiresPermission('dict.create.item')
  ...
  @Patch(':id')
  @RequiresPermission('dict.update.item')
  @ApiOperation({
    summary:
  ...
  @Delete(':id')
  @RequiresPermission('dict.delete.item')
  @ApiOperation({
    summary:
