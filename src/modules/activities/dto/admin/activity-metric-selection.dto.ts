...
export class AdminActivityMetricSetPointerDto {
...
/** Admin-only value. Pair semantics are also validated by the domain parser before any write. */
export class AdminActivityMetricSelectionInputDto {
  @ApiProperty({
  ...
  @ApiProperty({
    ...
    type: () => AdminActivityMetricSetPointerDto,
    nullable: true,
  })
  ...
  @ValidateNested()
  @Type(() => AdminActivityMetricSetPointerDto)
  metricSetPointer!: AdminActivityMetricSetPointerDto | null;
}

export class AdminSelectActivityMetricSetDto {
  @ApiProperty({
...
export class AdminActivityMetricSelectionResultDto {
...
export class AdminActivityMetricSelectionResponseDto {
  @ApiProperty({ description: 'Activity ID' }) activityId!: string;
  @ApiProperty({
