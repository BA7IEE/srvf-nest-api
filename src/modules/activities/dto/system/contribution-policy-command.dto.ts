...
import { ContributionPolicyDefinitionDto } from './contribution-policy.dto';

export class SystemCreateContributionPolicyDto {
  ...
  @ApiPropertyOptional({ description: '政策说明', minLength: 1, maxLength: 500 })
  @OmittableOnly()
  @IsString()
  @Length(1, 500)
  description?: string;
...
export class SystemCreateContributionPolicyVersionDto {
  @ApiProperty({ description: '幂等操作标识', minLength: 1, maxLength: 128 })
  @IsString()
  @Length(1, 128)
  operationKey!: string;
  ...
  @ApiProperty({
    description: '闭合贡献政策定义，canonical UTF8最多32768字节',
    type: ContributionPolicyDefinitionDto,
  })
  @ValidateNested()
  @Type(() => ContributionPolicyDefinitionDto)
...
export class SystemActivateContributionPolicyVersionDto {
  @ApiProperty({ description: '幂等操作标识', minLength: 1, maxLength: 128 })
  @IsString()
  @Length(1, 128)
  operationKey!: string;
...
export class SystemRetireContributionPolicyVersionDto {
  @ApiProperty({ description: '幂等操作标识', minLength: 1, maxLength: 128 })
  @IsString()
  @Length(1, 128)
  operationKey!: string;
...
export class SystemContributionPolicyCommandResponseDto {
  ...
  @ApiProperty({ description: '解释器版本', type: Number, nullable: true })
