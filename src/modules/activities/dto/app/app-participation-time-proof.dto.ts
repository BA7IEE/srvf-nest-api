...
export class AppParticipationTimeProofQueryDto extends PaginationQueryDto {
...
export class AppParticipationTimeProofItemDto {
  ...
  @ApiProperty({ enum: PROOF_CATEGORIES })
  sourceCategoryCode!: (typeof PROOF_CATEGORIES)[number];
...
export class AppParticipationTimeProofResponseDto {
  ...
  @ApiProperty({ type: AppParticipationTimeProofItemDto, isArray: true })
